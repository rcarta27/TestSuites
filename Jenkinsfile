pipeline {
    agent { 
            ...
            string(name: 'ApplicationScopeWithTests', defaultValue: 'CARDMRIITInitiatives', description: 'Comma-separated list of LifeTime applications to deploy (including test applications)')
