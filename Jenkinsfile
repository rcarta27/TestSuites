                ...
                expression { return params.ApplicationScope != params.ApplicationScopeWithTests }
                 ...
                 steps {
                        withPythonEnv('python3') {
                          ...
                          sh script: "python3 -m outsystems.pipeline.generate_unit_testing_assembly --artifacts \"${env.ArtifactsFolder}\" --app_list \"${params.ApplicationScopeWithTests}\" --cicd_probe_env ${'https://cmiti-dev.outsystemsenterprise.com/'} --bdd_framework_env ${'BDDFramework/rest/v1/BDDTestRunner/TestApp/HomeScreen'}", label: 'Generate URL endpoints for BDD test suites'
